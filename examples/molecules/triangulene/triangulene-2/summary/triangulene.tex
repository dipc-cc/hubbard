...
\begin{figure*}
	...
	\caption{\textbf{a,b,c} Spin polarization of the triangulene-dimer molecule H-passiated sites in different positions. \textbf{d,e,f} Density of states of molecules from the top row obtained at the enery of the HOMO for each case. A smearing parameter $\eta=1$ meV was used to obtain the DOS as a Lorentzian distribution.} 
\end{figure*}
