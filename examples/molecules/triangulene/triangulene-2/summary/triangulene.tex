...
\begin{figure*}
	...
	\caption{\textbf{a-e} Spin polarization of the extended molecule with H-passivated C-atom sites in five different positions obtained with $U=3.0$ eV. \textbf{f} Total energy difference between the molecules from \textbf{a-e} figures compared to the most estable configuration (pos-3) for different $U$ values.}
\end{figure*}
